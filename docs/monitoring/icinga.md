...
<figure markdown>
![Architektur](images/icinga/architecture.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Init Setup](images/icinga/init_setup.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Module](images/icinga/module.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Pakete](images/icinga/pakete.png){ width="1000", loading=lazy }
</figure>

### Icinga Web Authentifizierung
<figure markdown>
![Auth](images/icinga/auth.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![IcingaWebDB](images/icinga/icingaweb_db.png){ width="1000", loading=lazy }
</figure>

### Authentifizierungs-Backend
<figure markdown>
![Backend Name](images/icinga/backend_name.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Admin Account](images/icinga/admin_account.png){ width="1000", loading=lazy }
</figure>

### Logging Konfigurationen
<figure markdown>
![Log Config](images/icinga/log_config.png){ width="1000", loading=lazy }
</figure>

### Einrichtung von Icinga DB Web 
<figure markdown>
![Start IcingaDB](images/icinga/start_icingadb.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![IcingaDB](images/icinga/icingadb.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Redis](images/icinga/redis.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![API](images/icinga/api.png){ width="1000", loading=lazy }
</figure>
...
<figure markdown>
![Check](images/icinga/check.png){ width="1000", loading=lazy }
</figure>

<figure markdown>
![Check](images/icinga/success.png){ width="1000", loading=lazy }
</figure>
